...
[**getRandomAuthor**](SingleApi.md#getRandomAuthor) | **GET** /authors/random | Get Random Author
[**getRandomConcept**](SingleApi.md#getRandomConcept) | **GET** /concepts/random | /concepts/random
[**getRandomFunder**](SingleApi.md#getRandomFunder) | **GET** /funders/random | /funders/random
[**getRandomInstitution**](SingleApi.md#getRandomInstitution) | **GET** /institutions/random | /institutions/random
[**getRandomPublisher**](SingleApi.md#getRandomPublisher) | **GET** /publishers/random | /publishers/random
...
let body:.SingleApiGetAuthorRequest = {
  // string
  id: "A4",
  // string (optional)
...
let body:.SingleApiGetFunderRequest = {
  // any
  id: null,
  // string (optional)
  select: "select_example",
...
let body:.SingleApiGetInstitutionRequest = {
  // any
  id: null,
  // string (optional)
  select: "select_example",
...
let body:.SingleApiGetPublisherRequest = {
  // any
  id: null,
  // string (optional)
  select: "select_example",
...
let body:.SingleApiGetRandomAuthorRequest = {
  // string (optional)
  select: "select_example",
  // any | [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool) (optional)
  userAgent: null,
...
let body:.SingleApiGetRandomConceptRequest = {
  // string (optional)
  select: "select_example",
  // any | [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool) (optional)
  userAgent: null,
...
let body:.SingleApiGetRandomFunderRequest = {
  // string (optional)
  select: "select_example",
  // any | [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool) (optional)
  userAgent: null,
...
let body:.SingleApiGetRandomInstitutionRequest = {
  // string (optional)
  select: "select_example",
  // any | [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool) (optional)
  userAgent: null,
...
let body:.SingleApiGetRandomPublisherRequest = {
  // string (optional)
  select: "select_example",
  // any | [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool) (optional)
  userAgent: null,
...
let body:.SingleApiGetRandomSourceRequest = {
  // string (optional)
  select: "select_example",
  // any | [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool) (optional)
  userAgent: null,
...
let body:.SingleApiGetRandomWorkRequest = {
  // any (optional)
  select: null,
  // any | [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool) (optional)
  userAgent: null,
...
let body:.SingleApiGetSourceRequest = {
  // any
  id: null,
  // string (optional)
  select: "select_example",
