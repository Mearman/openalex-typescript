 ...
 * no description
 */
export class NgramsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async getWorkNgrams(id: any, userAgent?: any, mailto?: any, _options?: Configuration): Promise<RequestContext> {
        ...
        if (id === null || id === undefined) {
            throw new RequiredError("NgramsApi", "getWorkNgrams", "id");
        }
...
export class NgramsApiResponseProcessor {
