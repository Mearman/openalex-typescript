 ...
 * no description
 */
export class PeopleApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async getPerson(id: string, select?: string, userAgent?: any, mailto?: any, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new RequiredError("PeopleApi", "getPerson", "id");
        }
...
export class PeopleApiResponseProcessor {
