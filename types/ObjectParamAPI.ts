...
export class ObjectListApi {
    ...
    public getWorksWithHttpInfo(param: ListApiGetWorksRequest = {}, options?: Configuration): Promise<HttpInfo<WorksResponseSchema>> {
        return this.api.getWorksWithHttpInfo(param.apiKey, param.cursor, param.filter, param.groupBy, param.page, param.perPage, param.sample, param.search, param.select, param.sort, param.userAgent, param.mailto,  options).toPromise();
    }
    ...
    public getWorks(param: ListApiGetWorksRequest = {}, options?: Configuration): Promise<WorksResponseSchema> {
        return this.api.getWorks(param.apiKey, param.cursor, param.filter, param.groupBy, param.page, param.perPage, param.sample, param.search, param.select, param.sort, param.userAgent, param.mailto,  options).toPromise();
    }
