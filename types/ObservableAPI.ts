...
export class ObservableAuthorsApi {
     ...
     * @param mailto The API is the primary way to get OpenAlex data. It\&#39;s free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like &#x60;mailto:example@domain.com&#x60;, or in the User-Agent request header, like &#x60;User-Agent: my-app (mailto:example@domain.com)&#x60;. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).
     */
    public getAuthorsWithHttpInfo(filter?: string, groupBy?: string, groupBy2?: string, perPage?: number, page?: string, sample?: string, search?: string, select?: string, sort?: string, userAgent?: any, mailto?: any, _options?: Configuration): Observable<HttpInfo<AuthorsResponseSchema>> {
        const requestContextPromise = this.requestFactory.getAuthors(filter, groupBy, groupBy2, perPage, page, sample, search, select, sort, userAgent, mailto, _options);
     ...
     * @param mailto The API is the primary way to get OpenAlex data. It\&#39;s free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like &#x60;mailto:example@domain.com&#x60;, or in the User-Agent request header, like &#x60;User-Agent: my-app (mailto:example@domain.com)&#x60;. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).
     */
    public getAuthors(filter?: string, groupBy?: string, groupBy2?: string, perPage?: number, page?: string, sample?: string, search?: string, select?: string, sort?: string, userAgent?: any, mailto?: any, _options?: Configuration): Observable<AuthorsResponseSchema> {
        return this.getAuthorsWithHttpInfo(filter, groupBy, groupBy2, perPage, page, sample, search, select, sort, userAgent, mailto, _options).pipe(map((apiResponse: HttpInfo<AuthorsResponseSchema>) => apiResponse.data));
    }
...
export class ObservableConceptsApi {
     ...
     * @param mailto The API is the primary way to get OpenAlex data. It\&#39;s free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like &#x60;mailto:example@domain.com&#x60;, or in the User-Agent request header, like &#x60;User-Agent: my-app (mailto:example@domain.com)&#x60;. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).
     */
    public getConceptsWithHttpInfo(filter?: string, groupBy?: string, groupBy2?: string, perPage?: number, page?: string, sample?: string, search?: string, select?: string, sort?: string, userAgent?: any, mailto?: any, _options?: Configuration): Observable<HttpInfo<ConceptsResponseSchema>> {
        const requestContextPromise = this.requestFactory.getConcepts(filter, groupBy, groupBy2, perPage, page, sample, search, select, sort, userAgent, mailto, _options);
     ...
     * @param mailto The API is the primary way to get OpenAlex data. It\&#39;s free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like &#x60;mailto:example@domain.com&#x60;, or in the User-Agent request header, like &#x60;User-Agent: my-app (mailto:example@domain.com)&#x60;. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).
     */
    public getConcepts(filter?: string, groupBy?: string, groupBy2?: string, perPage?: number, page?: string, sample?: string, search?: string, select?: string, sort?: string, userAgent?: any, mailto?: any, _options?: Configuration): Observable<ConceptsResponseSchema> {
        return this.getConceptsWithHttpInfo(filter, groupBy, groupBy2, perPage, page, sample, search, select, sort, userAgent, mailto, _options).pipe(map((apiResponse: HttpInfo<ConceptsResponseSchema>) => apiResponse.data));
    }
...
export class ObservableFundersApi {
     ...
     * @param mailto The API is the primary way to get OpenAlex data. It\&#39;s free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like &#x60;mailto:example@domain.com&#x60;, or in the User-Agent request header, like &#x60;User-Agent: my-app (mailto:example@domain.com)&#x60;. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).
     */
    public getFundersWithHttpInfo(filter?: string, groupBy?: string, groupBy2?: string, perPage?: number, page?: string, sample?: string, search?: string, select?: string, sort?: string, userAgent?: any, mailto?: any, _options?: Configuration): Observable<HttpInfo<FundersArray>> {
        const requestContextPromise = this.requestFactory.getFunders(filter, groupBy, groupBy2, perPage, page, sample, search, select, sort, userAgent, mailto, _options);
     ...
     * @param mailto The API is the primary way to get OpenAlex data. It\&#39;s free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like &#x60;mailto:example@domain.com&#x60;, or in the User-Agent request header, like &#x60;User-Agent: my-app (mailto:example@domain.com)&#x60;. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).
     */
    public getFunders(filter?: string, groupBy?: string, groupBy2?: string, perPage?: number, page?: string, sample?: string, search?: string, select?: string, sort?: string, userAgent?: any, mailto?: any, _options?: Configuration): Observable<FundersArray> {
        return this.getFundersWithHttpInfo(filter, groupBy, groupBy2, perPage, page, sample, search, select, sort, userAgent, mailto, _options).pipe(map((apiResponse: HttpInfo<FundersArray>) => apiResponse.data));
    }
...
export class ObservableInstitutionsApi {
     ...
     * @param mailto The API is the primary way to get OpenAlex data. It\&#39;s free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like &#x60;mailto:example@domain.com&#x60;, or in the User-Agent request header, like &#x60;User-Agent: my-app (mailto:example@domain.com)&#x60;. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).
     */
    public getInstitutionsWithHttpInfo(filter?: string, groupBy?: string, groupBy2?: string, perPage?: number, page?: string, sample?: string, search?: string, select?: string, sort?: string, userAgent?: any, mailto?: any, _options?: Configuration): Observable<HttpInfo<InstitutionsResponseSchema>> {
        const requestContextPromise = this.requestFactory.getInstitutions(filter, groupBy, groupBy2, perPage, page, sample, search, select, sort, userAgent, mailto, _options);
     ...
     * @param mailto The API is the primary way to get OpenAlex data. It\&#39;s free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like &#x60;mailto:example@domain.com&#x60;, or in the User-Agent request header, like &#x60;User-Agent: my-app (mailto:example@domain.com)&#x60;. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).
     */
    public getInstitutions(filter?: string, groupBy?: string, groupBy2?: string, perPage?: number, page?: string, sample?: string, search?: string, select?: string, sort?: string, userAgent?: any, mailto?: any, _options?: Configuration): Observable<InstitutionsResponseSchema> {
        return this.getInstitutionsWithHttpInfo(filter, groupBy, groupBy2, perPage, page, sample, search, select, sort, userAgent, mailto, _options).pipe(map((apiResponse: HttpInfo<InstitutionsResponseSchema>) => apiResponse.data));
    }
...
export class ObservableListApi {
     ...
     * @param mailto The API is the primary way to get OpenAlex data. It\&#39;s free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like &#x60;mailto:example@domain.com&#x60;, or in the User-Agent request header, like &#x60;User-Agent: my-app (mailto:example@domain.com)&#x60;. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).
     */
    public getWorksWithHttpInfo(filter?: string, apiKey?: string, perPage?: number, cursor?: string, userAgent?: any, mailto?: any, _options?: Configuration): Observable<HttpInfo<WorksResponseSchema>> {
        const requestContextPromise = this.requestFactory.getWorks(filter, apiKey, perPage, cursor, userAgent, mailto, _options);
     ...
     * @param mailto The API is the primary way to get OpenAlex data. It\&#39;s free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like &#x60;mailto:example@domain.com&#x60;, or in the User-Agent request header, like &#x60;User-Agent: my-app (mailto:example@domain.com)&#x60;. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).
     */
    public getWorks(filter?: string, apiKey?: string, perPage?: number, cursor?: string, userAgent?: any, mailto?: any, _options?: Configuration): Observable<WorksResponseSchema> {
        return this.getWorksWithHttpInfo(filter, apiKey, perPage, cursor, userAgent, mailto, _options).pipe(map((apiResponse: HttpInfo<WorksResponseSchema>) => apiResponse.data));
    }
...
export class ObservablePublishersApi {
     ...
     * @param mailto The API is the primary way to get OpenAlex data. It\&#39;s free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like &#x60;mailto:example@domain.com&#x60;, or in the User-Agent request header, like &#x60;User-Agent: my-app (mailto:example@domain.com)&#x60;. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).
     */
    public getPublishersWithHttpInfo(filter?: string, groupBy?: string, groupBy2?: string, perPage?: number, page?: string, sample?: string, search?: string, select?: string, sort?: string, userAgent?: any, mailto?: any, _options?: Configuration): Observable<HttpInfo<PublishersResponseSchema>> {
        const requestContextPromise = this.requestFactory.getPublishers(filter, groupBy, groupBy2, perPage, page, sample, search, select, sort, userAgent, mailto, _options);
     ...
     * @param mailto The API is the primary way to get OpenAlex data. It\&#39;s free and requires no authentication. The daily limit for API calls is 100,000 requests per user per day. For best performance, add your email to all API requests The email can be either in the query string, like &#x60;mailto:example@domain.com&#x60;, or in the User-Agent request header, like &#x60;User-Agent: my-app (mailto:example@domain.com)&#x60;. Read more about the polite pool at [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool).
     */
    public getPublishers(filter?: string, groupBy?: string, groupBy2?: string, perPage?: number, page?: string, sample?: string, search?: string, select?: string, sort?: string, userAgent?: any, mailto?: any, _options?: Configuration): Observable<PublishersResponseSchema> {
        return this.getPublishersWithHttpInfo(filter, groupBy, groupBy2, perPage, page, sample, search, select, sort, userAgent, mailto, _options).pipe(map((apiResponse: HttpInfo<PublishersResponseSchema>) => apiResponse.data));
    }
