...
------------- | ------------- | -------------
[**getConcepts**](MultipleApi.md#getConcepts) | **GET** /concepts | /concepts
[**getDomainById**](MultipleApi.md#getDomainById) | **GET** /domains/{id} | /domains/{id}
[**getFieldById**](MultipleApi.md#getFieldById) | **GET** /field/{id} | /fields/{id}
...
let body:.MultipleApiGetConceptsRequest = {
  // string (optional)
...
let body:.MultipleApiGetDomainByIdRequest = {
  // any
  id: null,
  // number (optional)
  perPage: 3,
...
let body:.MultipleApiGetFieldByIdRequest = {
  // any
  id: null,
  // number (optional)
  perPage: 3,
