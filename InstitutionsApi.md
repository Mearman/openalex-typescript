...
------------- | ------------- | -------------
[**getAutocompleteInstitutions**](InstitutionsApi.md#getAutocompleteInstitutions) | **GET** /autocomplete/institutions | /autocomplete/institutions
[**getInstitution**](InstitutionsApi.md#getInstitution) | **GET** /institutions/{id} | /institutions/{id}
[**getInstitutions**](InstitutionsApi.md#getInstitutions) | **GET** /institutions | /institutions
[**getRandomInstitution**](InstitutionsApi.md#getRandomInstitution) | **GET** /institutions/random | /institutions/random
...
let body:.InstitutionsApiGetAutocompleteInstitutionsRequest = {
  // string (optional)
  q: "q_example",
...
let body:.InstitutionsApiGetInstitutionsRequest = {
  // string (optional)
...
let body:.InstitutionsApiGetRandomInstitutionRequest = {
  // string (optional)
  select: "select_example",
  // any | [docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication](https://docs.openalex.org/how-to-use-the-api/rate-limits-and-authentication#the-polite-pool) (optional)
  userAgent: null,
