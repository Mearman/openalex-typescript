...
------------- | ------------- | -------------
[**getAutocompleteSources**](SourcesApi.md#getAutocompleteSources) | **GET** /autocomplete/sources | /autocomplete/sources
...
let body:.SourcesApiGetAutocompleteSourcesRequest = {
  // string (optional)
  q: "q_example",
