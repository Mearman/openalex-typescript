...
------------- | ------------- | -------------
[**getAutocompleteFunders**](FundersApi.md#getAutocompleteFunders) | **GET** /autocomplete/funders | /autocomplete/funders
...
let body:.FundersApiGetAutocompleteFundersRequest = {
  // string (optional)
  q: "q_example",
